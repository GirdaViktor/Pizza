...
const Cart = () => {
  ...
  const count = cart.items.reduce((sum, obj) => obj.count + sum, 0);
  const totalPrice = cart.items.reduce((sum, obj) => obj.count * obj.price + sum, 0);
  ...
  return (
      <div className="cart">
        ...
        <div className="content__items">
          {
            cart.items.map(item => <CartItem {...item} key={item.id}/>)
          }
        </div>
